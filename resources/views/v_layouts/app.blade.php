			...
			<div class="home-wrap">
				...
				<div id="home-slick">
					...
					<div class="banner banner-1">
						<img src="{{  asset('frotend/img/banner01.jpg') }}" alt="">
						<div class="banner-caption text-center">
							<h1>Bags sale</h1>
					...
					<!-- banner -->
					<div class="banner banner-1">
						<img src="{{  asset('frotend/img/banner02.jpg') }}" alt="">
						<div class="banner-caption">
					...
					<!-- banner -->
					<div class="banner banner-1">
						<img src="{{  asset('frotend/img/banner03.jpg') }}" alt="">
						<div class="banner-caption">
	...
	<div class="section section-grey">
		...
		<div class="container">
			...
			<div class="row">
				...
				<div class="col-md-8">
					<div class="banner banner-1">
						<img src="{{  asset('frotend/img/banner13.jpg') }}" alt="">
						<div class="banner-caption text-center">
							<h1 class="primary-color">HOT DEAL<br><span class="white-color font-weak">Up to 50% OFF</span></h1>
							<button class="primary-btn">Shop Now</button>
						</div>
				...
				<div class="col-md-4 col-sm-6">
					<a class="banner banner-1" href="#">
						<img src="{{  asset('frotend/img/banner11.jpg') }}" alt="">
						<div class="banner-caption text-center">
							<h2 class="white-color">NEW COLLECTION</h2>
						</div>
					</a>
				...
				<div class="col-md-4 col-sm-6">
					<a class="banner banner-1" href="#">
						<img src="{{  asset('frotend/img/banner12.jpg') }}" alt="">
						<div class="banner-caption text-center">
							<h2 class="white-color">NEW COLLECTION</h2>
						</div>
					</a>
